...
namespace TommoJProductions.TurboMod.Parts
{
    class CarbPipePart : Part
    {
        ...
        {
            installed = false,
            position = new Vector3(1560, 5, 730),
        ...
        public CarbPipePart(PartSaveInfo inPartSaveInfo, GameObject inPart, GameObject inParent, Trigger inPartTrigger, Vector3 inPartPosition, Quaternion inPartRotation) : base(inPartSaveInfo, inPart, inParent, inPartTrigger, inPartPosition, inPartRotation)
        {
        }
